...
import { Globe, ArrowRight, Loader2, Mail, Lock, Eye, EyeOff, Sparkles, CheckCircle2, Trophy, ShieldCheck, Star, BookOpen, Clock, Activity } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col justify-center p-6 sm:p-10 md:p-16 lg:p-24 relative">
        ...
        <div className="flex items-center px-4 justify-center">
          ...
          >
            ...
            <h1 style={{ fontSize: '2.2rem', marginBottom: '0.75rem', color: '#0f172a', fontWeight: 900, fontFamily: 'Outfit, sans-serif', letterSpacing: '-0.03em', lineHeight: 1.15 }}>Welcome back</h1>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '-0.25rem' }}>
                <Link href="/forgot-password" style={{ fontSize: '0.8rem', color: 'hsl(var(--primary))', fontWeight: 700, textDecoration: 'none' }}>Forgot password?</Link>
              </div>
            ...
            <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.85rem', color: '#64748b', fontWeight: 500 }}>
              ...
              <Link href="/register" style={{ color: 'hsl(var(--primary))', fontWeight: 700, textDecoration: 'none' }}>
                Sign up for free
              </Link>
            </p>
          </motion.div>
