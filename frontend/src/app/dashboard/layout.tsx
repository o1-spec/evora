  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', backgroundColor: 'hsl(var(--bg-base))' }}>
      ...
      <motion.aside
        ...
        transition={{ type: 'spring', stiffness: 280, damping: 30, duration: 0.45 }}
        style={{
      ...
      >
        ...
        <motion.div
          ...
          style={{ height: '5rem', display: 'flex', alignItems: 'center', padding: '0 1.25rem', borderBottom: '1px solid hsl(var(--border))' }}
        >
        ...
        <motion.div
          ...
          style={{ padding: '1.25rem 0.75rem', borderTop: '1px solid hsl(var(--border))' }}
        >
