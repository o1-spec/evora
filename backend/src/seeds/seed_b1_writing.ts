...
async function main() {
  console.log("🌱 Seeding B1 Intermediate Writing Content...");

  // Load JSON file
  const jsonPath = path.join(__dirname, "b1_writing.json");
  ...
  console.log("✅ B1 Writing seeding completed successfully!");
}
