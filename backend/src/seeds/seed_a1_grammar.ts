...
async function main() {
  console.log("🌱 Seeding A1 Beginner Grammar Content...");

  // Load JSON file
  const jsonPath = path.join(__dirname, "a1_grammar.json");
  ...
  // 3. Create the 5 A1 Grammar modules
  ...
  let otherStartIdx = startIdx + modulesData.length; // vocabCount + grammarCount + 1
  ...
  console.log("✅ A1 Grammar seeding completed successfully!");
}
