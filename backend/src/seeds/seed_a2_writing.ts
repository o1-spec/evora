...
async function main() {
  console.log("🌱 Seeding A2 Elementary Writing Content...");

  // Load JSON file
  const jsonPath = path.join(__dirname, "a2_writing.json");
  ...
  console.log("✅ A2 Writing seeding completed successfully!");
}
