...
async function main() {
  console.log("🌱 Seeding B1 Intermediate Dialogue Content...");

  // Load JSON file
  const jsonPath = path.join(__dirname, "b1_dialogue.json");
  ...
  console.log("✅ B1 Dialogue seeding completed successfully!");
}
