...
async function main() {
  console.log("🌱 Seeding A1 Beginner Dialogue Content...");

  // Load JSON file
  const jsonPath = path.join(__dirname, "a1_dialogue.json");
  ...
  console.log("✅ A1 Dialogue seeding completed successfully!");
}
