...
async function main() {
  console.log("🌱 Seeding A2 Elementary Grammar Content...");

  // Load JSON file
  const jsonPath = path.join(__dirname, "a2_grammar.json");
  ...
  // 3. Create the A2 Grammar modules
  ...
  console.log("✅ A2 Grammar seeding completed successfully!");
}
